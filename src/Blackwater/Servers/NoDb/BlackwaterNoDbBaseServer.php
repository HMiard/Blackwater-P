...
use Blackwater\Utils\LighweightKernel;
use Ratchet\ConnectionInterface;

/**
 * Base class for all servers that require no database interactions.
 *
 * Class BlackwaterNoDbServer
 * @package Blackwater\Servers
 */
class BlackwaterNoDbBaseServer extends LighweightKernel
{
    /**
